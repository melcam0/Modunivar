header<-dashboardHeader(title = "Master")
...
sidebar<- dashboardSidebar(
    sidebarMenu(
                ...
                menuItem(text = "File",icon = icon("briefcase", lib = "font-awesome"),
                         ...
                         menuSubItem("Esercitazioni",tabName = "esercitazioni"),
  ...
  fluidRow(useShinyjs(),
    tabItems(
      tabItem(tabName = "esempi",
              ...
              column(12,
              selectInput("lista_esempi","",choices = c("",
                                                        "50volumi",
                                                        "Aberranti",
                                                        "Assorbanza",
                                                        "Betam",
                                                        ...
                                                        "Dati_DNA",
                                                        "Diuretico",
                                                        "L'azoto di Lord Rayleigh",
                                                        "LM_leverage",
                                                        "Medium",
                                                        "PreInt_1waov",
                                                        "Resa estrattiva",
                                                        "Resa estrattiva gruppi",
                                                        "R_P",
                                                        "Sacche_glucosata",
                                                        "Sacche_glucosata_gruppi",
                                                        "Van_Deemter" ),selected=1))),
              column(2,
      ...
      tabItem(tabName = "importa",
              fluidPage(titlePanel("Importa dati"),
                tabsetPanel(type = "tabs",
                            ...
                            tabPanel("Incolla",
                                     column(12,
                                            textAreaInput("file_incolla", "Incolla il DataSet",value = "Copia il DataSet e incolla qui ...",cols = 1,rows = 1)),
                                     column(2,
        ...
        fluidPage(titlePanel("Analisi della varianza"),
                  tabsetPanel(type = "tabs",
                              tabPanel("Anova: un fattore",
                                       ...
                                       column(4,
                                              h4("Ipotesi:"),
                                              h4(HTML("H<SUB>0</SUB>: &mu;<SUB>1</SUB> = &mu;<SUB>2</SUB> = ... =&mu;<SUB>n</SUB> <br>
                              ...
                              tabPanel("Anova: due fattori",
                                       ...
                                       column(4,
                                              h4("Ipotesi 1:"),
                                              h4(HTML("H<SUB>0,1</SUB>: &mu;<SUB>1,.</SUB> = &mu;<SUB>2,.</SUB> = ... =&mu;<SUB>n,.</SUB> <br>
                                                      H<SUB>1,1</SUB>: &mu;<SUB>i,.</SUB> &ne;&mu;<SUB>j,.</SUB> per almeno (i,j)")),
                                              br(),
                                       ...
                                       column(4,
                                              h4("Ipotesi 2:"),
                                              h4(HTML("H<SUB>0,2</SUB>: &mu;<SUB>.,1</SUB> = &mu;<SUB>.,2</SUB> = ... =&mu;<SUB>.,m</SUB> <br>
                                                      H<SUB>1,2</SUB>: &mu;<SUB>.,i</SUB> &ne;&mu;<SUB>.,j</SUB> per almeno (i,j)")),
                                              br(),
                  ...
                  tabsetPanel(type = "tabs",
                              tabPanel("Regressione",
                                       ...
                                       column(4,
                                              ...
                                              hr(),
                                              h3("Previsione"),
                                              numericInput(inputId = "regrsemplice_prevx",label = "Punto previsione",width = "30%",value = ""),
...
tabItem(tabName = "intconf",
        fluidPage(titlePanel("Stima della media"),
                  ...
                  column(2,
                         numericInput("int_conf_ds",label = "Deviazione standard",value=1)),
                  column(4,
...
tabItem(tabName = "h0",
        fluidPage(titlePanel("Test d'ipotesi"),
                  ...
                  column(2,
                         numericInput("h0_ds",label = "Deviazione standard",value=1)),
                  column(4,
        ...
        fluidPage(titlePanel("Potenza di un test"),
                  ...
                  column(4,      
                         ...
                         sliderInput(inputId="potenza_delta",label = "Differenza dalla media vera",min = 0,max = 10,value = 0,
                                     step=0.1),
                         sliderInput(inputId="potenza_ds",label = "Deviazione standard",min = 0.1,max = 5,value = 1,
                                     step=0.1),
...
tabItem(tabName = "anova",
        fluidPage(titlePanel("Analisi della varianza"),
                  ...
                  column(6),
                  column(2,
                         numericInput("anova_ds",label = "Deviazione standard",value=1)),
                  column(12,
        ...
        fluidPage(titlePanel("Regressione lineare semplice"),
                  tabsetPanel(type="tabs",
                              ...
                              tabPanel("Previsione",
                                       ...
                                       column(3,h4("Stima per intervallo (al 95%)"),
              ...
              fluidPage(
                tabsetPanel(type = "tabs",
                            tabPanel("Statistica descrittiva",
                                     htmlOutput("dispensa_descr")),
                            tabPanel("Statistica inferenzaiale",
                                     htmlOutput("dispensa_infer")),
                            tabPanel("Regressione",
                                     htmlOutput("dispensa_regr"))))),

      tabItem(tabName = "esercitazioni",
             fluidPage(
                tabsetPanel(type = "tabs",
                           tabPanel("Statistica descrittiva",
                           ...
                           tabPanel("Statistica inferenzaiale",
                                    htmlOutput("esercitazioni_infer")),
                           tabPanel("Anova",
